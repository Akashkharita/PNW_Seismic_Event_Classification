...
df_exp = pd.read_csv('utah_explosion_2023_2025.csv')
...
for i in tqdm(range(len(df_exp))):
    ...
    try:
        ...
        mdl.download(domain, restrictions, mseed_storage="../data/utah_explosion_2023_2025/waveforms/"+str(ev_id[i]),
                     stationxml_storage="../data/utah_explosion_2023_2025/stations/"+str(ev_id[i]))
