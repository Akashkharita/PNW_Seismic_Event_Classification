...
def extract_waveforms(cat, file_name):
    ...
    serial_no = []
    for i in range(150000, len(cat_trace)):
...
np.savez(
    "/home/ak287/PNW_ML_Classification/extracted_features/scatnet_features/p_10_40/comcat_scattering_coefficients_part4.npz",
