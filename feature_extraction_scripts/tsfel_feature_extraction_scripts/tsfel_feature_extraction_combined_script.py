...
## Example usage 
## python3 tsfel_feature_extraction_combined_script.py --low 1 --high 15 --new_sr 50 --start_time 10 --end_time 30 --taper_amount 10 --original_sr 100 --num_corners 4 --class_type explosion --part 1
...
for i in tqdm(range(len(resampled_data))):
    try:
        df = time_series_features_extractor(cfg_file, resampled_data[i], fs= new_sr, verbose = 0)
