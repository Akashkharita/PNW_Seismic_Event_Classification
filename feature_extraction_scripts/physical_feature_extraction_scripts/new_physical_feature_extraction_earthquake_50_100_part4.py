...
for i in tqdm(range(len(eq_Z))):
    try:
        ...
        df = seis_feature.FeatureCalculator(eq_Z[i]).compute_features()
...
X.to_csv('/home/ak287/PNW_Seismic_Event_Classification/extracted_features/new_physical_features_earthquake_z_part4_50_100.csv')
