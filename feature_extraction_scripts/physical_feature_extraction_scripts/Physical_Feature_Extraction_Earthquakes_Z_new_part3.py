...
for i in tqdm(range(75000, 125000)):
...
X.to_csv('/home/ak287/Data_Mining_in_the_PNW/Extracted_Features/Physical_Features/physical_features_comcat_z_earthquake_10_40_part3.csv')
